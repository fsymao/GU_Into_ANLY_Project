...
def Get_population(data):
    ...
    target_str='<b>Zip code population in 2010:</b>'
    population=''
...
def main():
    ...
    csv_dict['Zip code population in 2010']=population_ls
    ...
    dataframe=dataframe[['Zipcode', 'Zip code population in 2010', 'White population', 'Black population', 'American Indian population', \
               'Asian population', 'Native Hawaiian and Other Pacific Islander population', \
               'Some other race population', 'Two or more races population', \
